...
Security fixes apply to the current `main` branch. Generated projects are independent repositories and retain their own security policies after generation.
